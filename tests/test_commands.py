...
class TestTypeHints:
    ...
    def test_type_hints_stub_per_model(self, proj: Path) -> None:
        ...
        # The scaffold validation/articles.py has a passthrough (no class),
        # so no Literal types are generated — just the header and a note.
        assert "Auto-generated by `pbt type-hints`" in stub
